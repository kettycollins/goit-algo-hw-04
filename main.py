...
if __name__ == '__main__':
    ...
    print(f"{'| Timsort (sorted)': <20} | {time_small_timsort:<20.5f} | {time_medium_timsort:<20.5f}")
    print(f"{'| Timsort (sort)': <20} | {time_small_timsort_s:<20.5f} | {time_medium_timsort_s:<20.5f}")
